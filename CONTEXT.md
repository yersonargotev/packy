...
Delivery Authority observations, scope, acceptance obligations, starting base,
and iteration evidence. It records delivery authority, while its human status
projection is only a view; changed qualification facts make the bundle stale
rather than authorizing an in-place repair.

### Delivery Authority
The accepted source of scope and acceptance obligations for one issue delivery.
It is either a self-contained approved issue or an issue with a separate
authoritative specification.

### Self-contained Issue
An approved issue whose objective, verifiable acceptance criteria, necessary
boundaries, dependencies, and prior decisions form the complete Delivery
Authority.

### Issue with Specification
An issue whose Delivery Authority includes a separate normative source because
that source is shared, external, or independently identified and versioned.

### Delivery Risk Profile
The explicitly qualified level of delivery assurance required by a change's
observable effects. It defaults to standard, and mechanical policy may raise but
never lower it; the profile selects local assurance policy without weakening the
invariant delivery controls.

### Low-risk Delivery
An issue delivery with no distributed-product or sensitive-boundary effect,
limited to passive artifacts or fail-closed reinforcement of existing
repository validation.

### Standard Delivery
An issue delivery that changes ordinary, reversible product behavior without
crossing an installation, real-configuration, publication, migration, security,
or other sensitive boundary.

### High-risk Delivery
An issue delivery that crosses a sensitive or hard-to-reverse boundary such as
installation, real configuration, security, publication, migration, persistent
formats, governance, or destructive external effects.

### Delivery Candidate
The complete proposed repository change reviewed and validated as one delivery,
independent of how many local commits produced it.

### Bounded Repair
A correction to a Delivery Candidate that preserves behavior, contract, scope,
architecture, security posture, and acceptance meaning.

### Candidate-changing Repair
A correction that changes a Delivery Candidate's behavior, contract, scope,
architecture, security posture, or acceptance meaning.

### Delivery Run
One uniquely identified, resumable execution of an issue delivery, with at most
one active run per repository and issue. It reacquires observable facts between
phases and pauses when caller judgment, external mutation authority, or remote
