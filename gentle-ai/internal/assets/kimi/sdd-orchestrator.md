...
- **Fresh-context reviewer for high-risk phases** (`sdd-design`, `sdd-apply`): invoke a fresh-context reviewer custom-agent for independent judgment, because errors in these phases compound downstream.
