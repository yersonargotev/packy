...
func TestInspectRoutesV23RegisterToSingleSourceAdmission(t *testing.T) {
	...
	manifest, manifestDigest, err := packsyncworkflow.CanonicalProposedManifest(json.RawMessage(`{"id":"new-pack","version":"1.0.0","description":"Coordinate work","selectable":true,"surfaces":["codex"],"external_requirements":[],"resources":[{"kind":"notice","id":"mit","source":"notices/mit","description":"Preserves the upstream MIT license and attribution","license":"MIT","attribution":"Example","requires":[],"conflicts":[],"bindings":[],"surface_exclusions":[]},{"kind":"skill","id":"coordinate","source":"skills/coordinate","description":"Coordinates focused work","requires":[],"conflicts":[],"notices":["notice:mit"],"bindings":[{"surface":"codex","projection":"skill","name":"coordinate","invocation":"$coordinate","mode":"native","sharing":"exclusive"}],"surface_exclusions":[]}],"exclusions":[]}`))
	if err != nil {
		t.Fatal(err)
	}
