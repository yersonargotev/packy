...
var acceptanceRows = []AcceptanceRow{
	...
	{"VERCEL-ACCEPTANCE-09", Gate(3), HostCodex, EvidenceFoundation, "codex-lifecycle-safety", "./internal/codex/TestVercelFixtureProjectsNineCompleteNativeSkillTreesReversibly", "./internal/capabilitypack/TestCodexVercelLifecycleWriteBoundaryAndExactDiff", "./internal/capabilitypack/TestCodexVercelLifecycleWriteBoundaryAndExactDiff", "one write boundary fails", "exact permitted Codex diff"},
	{"VERCEL-ACCEPTANCE-10", Gate(3), HostOpenCode, EvidenceFoundation, "opencode-lifecycle-safety", "./internal/opencode/TestVercelFixtureProjectsNineCompleteNativeSkillTreesReversibly", "./internal/capabilitypack/TestOpenCodeVercelLifecycleWriteBoundaryAndExactDiff", "./internal/capabilitypack/TestOpenCodeVercelLifecycleWriteBoundaryAndExactDiff", "one write boundary fails", "exact permitted OpenCode diff"},
	{"VERCEL-ACCEPTANCE-11", Gate(3), HostClaude, EvidenceFoundation, "claude-lifecycle-safety", "./internal/claudecode/TestVercelFixtureProjectsNineCompleteNativeSkillTreesReversibly", "./internal/capabilitypack/TestClaudeVercelLifecycleWriteBoundaryAndExactDiff", "./internal/capabilitypack/TestClaudeVercelLifecycleWriteBoundaryAndExactDiff", "one write boundary fails", "exact permitted Claude diff"},
