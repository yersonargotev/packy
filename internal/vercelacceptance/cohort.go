...
const (
	EvidenceFoundation EvidenceSource = iota + 1
	EvidenceHost
)
...
type AcceptanceRow struct {
	...
	Source       EvidenceSource `json:"evidence_source"`
...
var acceptanceRows = []AcceptanceRow{
	{"VERCEL-ACCEPTANCE-01", Gate(1), "", EvidenceFoundation, "exact-composite-candidate", "./internal/packsync/TestVercelLegalAdmissionEvidence", "./internal/packsync/TestValidateLegalAdmissionRejectsOneFactNegativeTwins", "./internal/packsync/TestCompositeLegalAdmissionRequiresDurableExactEvidence", "one source identity differs", "zero candidate-byte diff"},
	{"VERCEL-ACCEPTANCE-02", Gate(1), "", EvidenceFoundation, "source-provenance-and-locks", "./internal/tools/syncpacksource/TestCompositeBundleTracerReacquiresEveryMemberAndPublishesPackScope", "./internal/packsync/TestCompositeRejectsInvalidSetsAndStaleFactsBeforeWrites", "./internal/packsync/TestRevalidateCompositeCandidatesRequiresEveryExactMember", "one provenance fact differs", "exact lock-set digest"},
	{"VERCEL-ACCEPTANCE-03", Gate(1), "", EvidenceFoundation, "primary-legal-admission", "./internal/packsync/TestVercelLegalAdmissionEvidence", "./internal/packsync/TestValidateLegalAdmissionRejectsOneFactNegativeTwins", "./internal/packsync/TestCompositeLegalAdmissionRequiresDurableExactEvidence", "primary authority is absent or stale", "exact documentary digest"},
	{"VERCEL-ACCEPTANCE-04", Gate(1), "", EvidenceFoundation, "secondary-notices", "./internal/vercelacceptance/TestExactSelectedTreesAreCompleteInertAndSealed", "./internal/vercelacceptance/TestMissingNoticeAndBindingTwinsFailWithoutMutation", "./internal/vercelacceptance/TestValidateRejectsEverySealedFixtureGroup", "one MIT notice is absent", "exact notice bytes"},
	{"VERCEL-ACCEPTANCE-05", Gate(2), "", EvidenceFoundation, "complete-skill-inventory", "./internal/vercelacceptance/TestExactSelectedTreesAreCompleteInertAndSealed", "./internal/vercelacceptance/TestNegativeTwinsFailDeterministicallyWithoutMutation", "./internal/vercelacceptance/TestCanonicalExactClosureAndV4RoundTrip", "one selected skill tree is absent", "exact nine-tree inventory"},
	{"VERCEL-ACCEPTANCE-06", Gate(2), "", EvidenceFoundation, "native-three-surface-bindings", "./internal/vercelacceptance/TestExactSelectedTreesAreCompleteInertAndSealed", "./internal/vercelacceptance/TestMissingNoticeAndBindingTwinsFailWithoutMutation", "./internal/vercelacceptance/TestCanonicalExactClosureAndV4RoundTrip", "one native binding is absent", "exact 27-binding set"},
	{"VERCEL-ACCEPTANCE-07", Gate(2), "", EvidenceFoundation, "sealed-loader-closure", "./internal/vercelacceptance/TestExactSelectedTreesAreCompleteInertAndSealed", "./internal/vercelacceptance/TestNegativeTwinsFailDeterministicallyWithoutMutation", "./internal/vercelacceptance/TestGuidelineAdaptationsAndSealedIdentities", "one loader uses a moving reference", "zero runtime network reads"},
	{"VERCEL-ACCEPTANCE-08", Gate(2), "", EvidenceFoundation, "runtime-mode-contract", "./internal/vercelacceptance/TestCanonicalRuntimeContractHasFreshExactCodexPreflight", "./internal/capabilitypack/TestEvaluateRuntimeModesRequiresExactCoverageAndSecretSafeDiagnostics", "./internal/capabilitypack/TestRuntimeModeFingerprintIgnoresFreshTimestampButSealsSemanticChanges", "one mode fact is omitted", "exact 28-mode set"},
	{"VERCEL-ACCEPTANCE-09", Gate(3), HostCodex, EvidenceFoundation, "codex-lifecycle-safety", "./internal/codex/TestVercelFixtureProjectsNineCompleteNativeSkillTreesReversibly", "./internal/capabilitypack/TestVercelLifecycleIsAtomicStaleSafeRecoverableAndOwnershipSafe", "./internal/capabilitypack/TestVercelLifecycleIsAtomicStaleSafeRecoverableAndOwnershipSafe", "one write boundary fails", "exact permitted Codex diff"},
	{"VERCEL-ACCEPTANCE-10", Gate(3), HostOpenCode, EvidenceFoundation, "opencode-lifecycle-safety", "./internal/opencode/TestVercelFixtureProjectsNineCompleteNativeSkillTreesReversibly", "./internal/capabilitypack/TestVercelLifecycleIsAtomicStaleSafeRecoverableAndOwnershipSafe", "./internal/capabilitypack/TestVercelLifecycleIsAtomicStaleSafeRecoverableAndOwnershipSafe", "one write boundary fails", "exact permitted OpenCode diff"},
	{"VERCEL-ACCEPTANCE-11", Gate(3), HostClaude, EvidenceFoundation, "claude-lifecycle-safety", "./internal/claudecode/TestVercelFixtureProjectsNineCompleteNativeSkillTreesReversibly", "./internal/capabilitypack/TestVercelLifecycleIsAtomicStaleSafeRecoverableAndOwnershipSafe", "./internal/capabilitypack/TestVercelLifecycleIsAtomicStaleSafeRecoverableAndOwnershipSafe", "one write boundary fails", "exact permitted Claude diff"},
	{"VERCEL-ACCEPTANCE-12", Gate(3), "", EvidenceFoundation, "ownership-and-cross-surface-isolation", "./internal/capabilitypack/TestVercelLifecycleIsAtomicStaleSafeRecoverableAndOwnershipSafe", "./internal/capabilitypack/TestVercelCollisionRequiresExplicitAliasBeforeMutation", "./internal/capabilitypack/TestVercelLifecycleIsAtomicStaleSafeRecoverableAndOwnershipSafe", "foreign content or another surface changes", "zero foreign/cross-surface mutation"},
	{"VERCEL-ACCEPTANCE-13", Gate(4), HostCodex, EvidenceFoundation, "codex-disclosure-and-preflight", "./internal/vercelacceptance/TestCanonicalRuntimeContractHasFreshExactCodexPreflight", "./internal/capabilitypack/TestEvaluateRuntimeModesRequiresExactCoverageAndSecretSafeDiagnostics", "./internal/codexsmoke/TestExactFixtureProjectsNineCodexSkills", "one indispensable input is missing", "fail before effects"},
	{"VERCEL-ACCEPTANCE-14", Gate(4), HostOpenCode, EvidenceFoundation, "opencode-disclosure-and-preflight", "./internal/opencodesmoke/TestPreflightEveryVercelModeFailsBeforeHostEffects", "./internal/opencodesmoke/TestPreflightEveryVercelModeFailsBeforeHostEffects", "./internal/opencodesmoke/TestPreflightEveryVercelModeFailsBeforeHostEffects", "one indispensable input is missing", "fail before effects"},
	{"VERCEL-ACCEPTANCE-15", Gate(4), HostClaude, EvidenceFoundation, "claude-disclosure-and-preflight", "./internal/claudesmoke/TestVercelRuntimeEvidenceCoversExactTwentyEightModesSafely", "./internal/claudesmoke/TestValidateVercelEvidenceExactNamesCountsAndSafety", "./internal/claudesmoke/TestVercelRuntimeEvidenceCoversExactTwentyEightModesSafely", "one indispensable input is missing", "fail before effects"},
	{"VERCEL-ACCEPTANCE-16", Gate(4), "", EvidenceFoundation, "secret-free-tristate-contract", "./internal/capabilitypack/TestRuntimeEvidenceIsTriStateDeterministicAndSecretSafe", "./internal/capabilitypack/TestEvaluateRuntimeModesRequiresExactCoverageAndSecretSafeDiagnostics", "./internal/capabilitypack/TestRuntimeModeFingerprintIgnoresFreshTimestampButSealsSemanticChanges", "one sensitive value is present", "zero secret-bearing fields"},
	{"VERCEL-ACCEPTANCE-17", Gate(5), HostCodex, EvidenceHost, "codex-exact-host-readiness", "host-artifact/codex-0.145.0", "host-artifact/codex-missing-one", "host-artifact/codex-exact-inventory", "one skill is removed", "nine skills and 28 modes"},
	{"VERCEL-ACCEPTANCE-18", Gate(5), HostOpenCode, EvidenceHost, "opencode-exact-host-readiness", "host-artifact/opencode-1.18.5", "host-artifact/opencode-missing-one", "host-artifact/opencode-exact-inventory", "one skill is removed", "nine skills and 28 modes"},
	{"VERCEL-ACCEPTANCE-19", Gate(5), HostClaude, EvidenceHost, "claude-exact-host-readiness", "host-artifact/claude-2.1.203", "host-artifact/claude-missing-one", "host-artifact/claude-exact-inventory", "one skill is removed", "nine skills and 28 modes"},
	{"VERCEL-ACCEPTANCE-20", Gate(5), "", EvidenceFoundation, "compatibility-classification", "./internal/vercelacceptance/TestExactSelectedTreesAreCompleteInertAndSealed", "./internal/packsync/TestCanonicalCompositePackManifestParityAndSemanticChange", "./internal/vercelacceptance/TestCompatibilityAndAliasPolicyMatchTheFirstContract", "one observable contract fact changes", "maximum impact classification"},
	{"VERCEL-ACCEPTANCE-21", Gate(6), "", EvidenceFoundation, "independent-reacquisition", "./internal/tools/syncpacksource/TestCompositeBundleTracerReacquiresEveryMemberAndPublishesPackScope", "./internal/packsync/TestRevalidateCompositeCandidatesRequiresEveryExactMember", "./internal/tools/syncpacksource/TestCompositeBundleTracerReacquiresEveryMemberAndPublishesPackScope", "one acquired byte differs", "identical candidate digest"},
	{"VERCEL-ACCEPTANCE-22", Gate(6), "", EvidenceFoundation, "publication-reproduction", "./internal/tools/syncpacksource/TestCompositeBundleTracerReacquiresEveryMemberAndPublishesPackScope", "./internal/packsync/TestCompositeRejectsInvalidSetsAndStaleFactsBeforeWrites", "./internal/tools/syncpacksource/TestCompositeBundleTracerReacquiresEveryMemberAndPublishesPackScope", "one plan or bundle byte differs", "identical plan and bundle"},
	{"VERCEL-ACCEPTANCE-23", Gate(6), "", EvidenceFoundation, "proposal-safety", "./internal/ci/TestSyncWorkflowIsManualPinnedLeastPrivilegeAndPhaseSeparated", "./internal/ci/TestWorkflowTrustBoundaryMutationsFailClosed", "./internal/ci/TestSyncWorkflowIsManualPinnedLeastPrivilegeAndPhaseSeparated", "proposal state or privilege broadens", "least privilege and one proposal"},
	{"VERCEL-ACCEPTANCE-24", Gate(6), "", EvidenceFoundation, "complete-fresh-cohort", "./internal/vercelacceptance/TestCanonicalCohortReportAndDeterministicRerun", "./internal/vercelacceptance/TestCohortRejectsMissingDuplicateMixedStaleTamperedAndFailedEvidence", "./internal/vercelacceptance/TestCohortSuppressesEveryRowAfterFirstFailure", "one prior row is stale", "all 24 fresh fingerprints"},
}

func Rows() []AcceptanceRow { return append([]AcceptanceRow(nil), acceptanceRows...) }

func FoundationRows() []AcceptanceRow {
	return rowsBySource(EvidenceFoundation)
}

func HostRows() []AcceptanceRow {
	return rowsBySource(EvidenceHost)
}

func rowsBySource(source EvidenceSource) []AcceptanceRow {
