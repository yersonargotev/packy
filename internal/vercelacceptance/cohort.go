...
var acceptanceRows = []AcceptanceRow{
	...
	{"VERCEL-ACCEPTANCE-09", Gate(3), HostCodex, EvidenceFoundation, "codex-lifecycle-safety", "./internal/codex/TestVercelFixtureProjectsNineCompleteNativeSkillTreesReversibly", "./internal/codex/TestVercelLifecycleExercisesEveryCodexWriteBoundaryAndExactDiff", "./internal/codex/TestVercelLifecycleExercisesEveryCodexWriteBoundaryAndExactDiff", "one write boundary fails", "exact permitted Codex diff"},
	{"VERCEL-ACCEPTANCE-10", Gate(3), HostOpenCode, EvidenceFoundation, "opencode-lifecycle-safety", "./internal/opencode/TestVercelFixtureProjectsNineCompleteNativeSkillTreesReversibly", "./internal/opencode/TestVercelLifecycleExercisesEveryOpenCodeWriteBoundaryAndExactDiff", "./internal/opencode/TestVercelLifecycleExercisesEveryOpenCodeWriteBoundaryAndExactDiff", "one write boundary fails", "exact permitted OpenCode diff"},
	{"VERCEL-ACCEPTANCE-11", Gate(3), HostClaude, EvidenceFoundation, "claude-lifecycle-safety", "./internal/claudecode/TestVercelFixtureProjectsNineCompleteNativeSkillTreesReversibly", "./internal/claudecode/TestVercelLifecycleExercisesEveryClaudeWriteBoundaryAndExactDiff", "./internal/claudecode/TestVercelLifecycleExercisesEveryClaudeWriteBoundaryAndExactDiff", "one write boundary fails", "exact permitted Claude diff"},
