...
// migrateV4Ownership migrates capability-pack ownership. Conflicting facts for
// the same physical identity are dropped so the target remains conservatively
