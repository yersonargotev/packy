...
func TestVercelCodexCollisionRequiresExplicitAliasBeforeMutation(t *testing.T) {
	testVercelCollisionRequiresExplicitAliasBeforeMutation(t, SurfaceCodex)
}

func TestVercelOpenCodeCollisionRequiresExplicitAliasBeforeMutation(t *testing.T) {
	testVercelCollisionRequiresExplicitAliasBeforeMutation(t, SurfaceOpenCode)
}
...
func TestVercelOpenCodeLifecycleIsAtomicStaleSafeRecoverableAndOwnershipSafe(t *testing.T) {
