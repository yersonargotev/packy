...
var realCatalogTestExceptions = map[string]realCatalogException{
	...
	"internal/ci/issue672_engram_source_test.go:TestIssue672EngramPackPreservesReviewedRuntimeContract":                      {realCatalogPublicContract, "Protects Engram's reviewed runtime and resource contract independently of its current provenance model."},
