...
var realCatalogTestExceptions = map[string]realCatalogException{
	...
	"internal/ci/issue704_issue_delivery_managed_pack_test.go:TestIssue704IssueDeliveryManagedPackOwnsCurrentRuntimeContractAndClosure": {realCatalogPublicContract, "Protects Issue Delivery's Managed Pack runtime contract and exact admitted closure."},
	...
	"internal/cli/issue579_pack_show_inventory_test.go:TestPackShowJSONV6IncludesDescriptiveInventory":                                  {realCatalogPublicContract, "Protects Engram's checked-in resource inventory in the public structured show contract."},
	...
	"internal/cli/pack_test.go:TestPackListUsesOneCapturedWorkstationForExplicitDevelopmentSource":                                      {realCatalogPublicContract, "Protects explicit development-source selection without retaining the obsolete repository-discovery production route."},
