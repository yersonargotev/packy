...
var realCatalogTestExceptions = map[string]realCatalogException{
	...
	"internal/ci/issue672_engram_source_test.go:TestIssue672EngramPackUsesExactUpstreamSkill":                                {realCatalogGeneratedEvidence, "Protects the admitted Engram manifest and its exact generated upstream resource evidence."},
